...
class _ChatScreenState extends State<ChatScreen> {
  ...
  final List<Map<String, dynamic>> _messages = [
    {
      'text': 'Hi, I\'m interested in this property', // Placeholder
      'isMe': false,
      'time': '17:40',
      'sender': 'Ric (Landlord)',
    },
    ...
    {
      'type': 'image',
      'imageUrl': 'https://plus.unsplash.com/premium_photo-1661963069512-1981b0a88b52?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      'isMe': false,
      'time': '17:45',
      'sender': 'Ric (Landlord)',
  ...
  void initState() {
    super.initState();
    // Replace the initial message with the actual property title
    if (_messages.isNotEmpty && !_messages.first['isMe']) {
      _messages[0]['text'] =
          'Hi, I\'m interested in ${widget.propertyTitle}';
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Container( // Message bubble container
                  ...
                  decoration: BoxDecoration(
                    color: isMe
                        ? (isImage ? Colors.transparent : AppTheme.primaryRed)
                        : AppTheme.cardColor(context),
                    borderRadius: isImage ? BorderRadius.circular(12) : BorderRadius.circular(18).copyWith(
  ...
  Widget _buildMessageStatus(Map<String, dynamic> message) {
    ...
    if (message['isMe'] != true) return const SizedBox();
